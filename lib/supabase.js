...
class SupabaseClient {
  ...
  async shareRelationSafe(params) {
    return this._fetch('/rpc/share_relation_safe', {
      method: 'POST',
  ...
  async getDeprecatedUpdates(threshold = 3) {
    return this._fetch('/rpc/get_deprecated_updates', {
      method: 'POST',
  ...
  async submitFeedback(feedback) {
    return this._fetch('/integration_feedback', {
      method: 'POST',
      headers: { 'Prefer': 'return=minimal' },
  ...
  async getFeedbackSummary() {
    return this._fetch('/rpc/get_feedback_summary', {
      method: 'POST',
      body: JSON.stringify({})
    });
  }
